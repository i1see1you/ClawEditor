...
export class OpenClawWsChannel {
  ...
  private buildEditIntentParseMessage(params: {
    ...
    const lines = [
      ...
      '必须使用 version:2，且 intent 为「有序数组」：上一步输出的全文作为下一步输入（类 shell 管道）；客户端只对比原始全文与最终一步结果一次。',
      '单步示例：{"version":2,"intent":[{"op":"dedupe_lines","scope":"auto"}]}；多步示例：{"version":2,"intent":[{"op":"replace_regex","scope":"auto","pattern":"\\\\n\\\\n+","flags":"g","replacement":"\\\\n"},{"op":"dedupe_lines","scope":"auto"}]}。',
